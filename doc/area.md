...
The syntax of this section is:
	...
	<description:string>
	<act-flags:number> <affected-flags:number> <clan:number> S
...
The 'clan' of the mobile ranges from 0 to 6.  At least on Chaosium it does.
...
NOTE: the "area" slot is now used for clans. - Alathon
